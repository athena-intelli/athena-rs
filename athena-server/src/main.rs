...
use athena_api::pb::box_service::box_service_server::BoxServiceServer;
...
use crate::services::box_service::BoxServiceImpl;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let box_service = BoxServiceServer::new(BoxServiceImpl::default());
